...
This document provides guidelines for internationalization of the VEKTORCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vektorcoin_en.ts` remains unchanged.
