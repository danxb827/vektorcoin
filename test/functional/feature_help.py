...
"""Verify that starting vektorcoin with -h works as expected."""

from test_framework.test_framework import VEKTORCOINTestFramework
from test_framework.util import assert_equal

class HelpTest(VEKTORCOINTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vektorcoin with -h for help text")
        ...
        self.log.info("Start vektorcoin with -version for version information")
        ...
        self.log.info("Start vektorcoind with -fakearg to make sure it does not start")
