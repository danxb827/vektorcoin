...
# TestP2PConn: A peer we use to send messages to vektorcoind, and store responses.
...
class CompactBlocksTest(VEKTORCOINTestFramework):
    ...
    # This test actually causes vektorcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vektorcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vektorcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # vektorcoind will not send blocktxn responses for blocks whose height is
