...
class BIP66Test(VEKTORCOINTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # vektorcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and vektorcoind produces more specific reject
            # reasons.
