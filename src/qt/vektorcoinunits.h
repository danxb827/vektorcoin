...
#ifndef VEKTORCOIN_QT_VEKTORCOINUNITS_H
#define VEKTORCOIN_QT_VEKTORCOINUNITS_H
...
/** VEKTORCOIN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VEKTORCOINUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VEKTORCOINUnits(QObject *parent);

    /** VEKTORCOIN units.
      @note Source: https://en.vektorcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VEKTOR,
...
typedef VEKTORCOINUnits::Unit VEKTORCOINUnit;

#endif // VEKTORCOIN_QT_VEKTORCOINUNITS_H
