    ...
    mapper(0)
{
    ...
    ui->vektorcoinAtStartup->setToolTip(ui->vektorcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->vektorcoinAtStartup->setText(ui->vektorcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openVEKTORCOINConfButton->setToolTip(ui->openVEKTORCOINConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new VEKTORCOINUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vektorcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVEKTORCOINConfButton_clicked()
{
