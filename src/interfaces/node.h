...
#ifndef VEKTORCOIN_INTERFACES_NODE_H
#define VEKTORCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a vektorcoin node (vektorcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // VEKTORCOIN_INTERFACES_NODE_H
