...
static void SetupVEKTORCOINTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vektorcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vektorcoin-tx [options] <hex-tx> [commands]  Update hex-encoded vektorcoin transaction\n" +
            "or:     vektorcoin-tx [options] -create [commands]   Create hex-encoded vektorcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vektorcoin transaction
