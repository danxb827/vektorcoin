...
{
    BOOST_CHECK(TestSplitHost("www.vektorcoincore.org", "www.vektorcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.vektorcoincore.org]", "www.vektorcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.vektorcoincore.org:80", "www.vektorcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.vektorcoincore.org]:80", "www.vektorcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:28876", "127.0.0.1", 28876));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:28876", "127.0.0.1", 28876));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:28876", "::ffff:127.0.0.1", 28876));
    BOOST_CHECK(TestSplitHost("[::]:28876", "::", 28876));
    BOOST_CHECK(TestSplitHost("::28876", "::28876", -1));
    BOOST_CHECK(TestSplitHost(":28876", "", 28876));
    BOOST_CHECK(TestSplitHost("[]:28876", "", 28876));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:28876", "127.0.0.1:28876"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:28876", "[::]:28876"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
