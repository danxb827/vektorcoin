...
#ifndef VEKTORCOIN_TEST_SCRIPTNUM10_H
#define VEKTORCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from VEKTORCOIN Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // VEKTORCOIN_TEST_BIGNUM_H
