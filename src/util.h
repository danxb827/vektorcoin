 ...
 */
#ifndef VEKTORCOIN_UTIL_H
#define VEKTORCOIN_UTIL_H
...
extern const char * const VEKTORCOIN_CONF_FILENAME;
extern const char * const VEKTORCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("vektorcoin-%s", name);
