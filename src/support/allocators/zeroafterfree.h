...
#ifndef VEKTORCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define VEKTORCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // VEKTORCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
