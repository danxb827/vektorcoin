...
#ifndef VEKTORCOIN_KEYSTORE_H
#define VEKTORCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/vektorcoin/bips/blob/master/bip-0013.mediawiki
