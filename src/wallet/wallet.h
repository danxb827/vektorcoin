...
#ifndef VEKTORCOIN_WALLET_WALLET_H
#define VEKTORCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this vektorcoin node, and set to 0 for transactions that were created
...
#endif // VEKTORCOIN_WALLET_WALLET_H
